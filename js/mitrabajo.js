function init() {
    ...
    const exploreBtn = slider.querySelector(".slider .nav .explore-btn"); // Botón Explore
    ...
    exploreBtn.onclick = function() {
        ...
        const sectionTitle = activeItem.querySelector(".wrap").textContent.trim();
        const url = sectionLinks[sectionTitle] || "#"; // URL predeterminada en caso de que no se encuentre la sección
